...
<div :class="$style.root">
	...
	<div v-if="!narrow && !isRoot && isVisitorDashboardAvailable" :class="$style.side">
	...
	<div :class="$style.main">
		<div v-if="narrow && !isRoot" :class="$style.header">
			...
			<MkButton v-if="isDetailedVisitorMenuAvailable" primary rounded :class="$style.headerButton" @click="goHome">{{ i18n.ts.signup }}</MkButton>
		</div>
